class List {
	...
	createButton(text, height) {
		this.buttons.push(new Button(5,5+this.buttons.length*height, this.w-20, height));
		let i=this.buttons.length-1;
		this.buttons[i].setText(text.text, text.size, text.dist);
		this.buttons[i].setAlign(0);
		this.buttons[i].targetWindow=this;
